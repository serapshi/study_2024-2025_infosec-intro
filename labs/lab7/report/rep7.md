...
является фрагментом истинно случайной двоичной послеедовательности с
...
Мною были написаны 3 функции на языке Python, в среде .ipynb. Мною написанны функция для создания случайного ключа, и две функции для шифрования и дешифрования(рис. [-@fig:001]).
